...
function App() {
  ...
  for(let i = 0; i < products.length; i++){
    prods.push(<Product id={products[i].id} image={products[i].thumbnail} discount={products[i].discountPercentage} brand={products[i].brand} description={products[i].description} rating={products[i].rating} price={products[i].price}/>)
  }
  return (
    <>
